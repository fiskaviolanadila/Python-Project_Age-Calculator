...
photo = PhotoImage(file=r"C:\Users\ACER\Downloads\Age calculator.png")
...
def calculateAge():
    ...
    resultLabel.config(text=f"{nameValue.get()} your age is {age}")
...
resultLabel = Label(root, text="", font=30)
